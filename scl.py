...
lam = 0.5  # lambda for loss
train_path = "sst-2/train.csv"
valid_path = "sst-2/val.csv"
...
def prepare_data(num_train, train_path, valid_path, seed):
    ...
    val_ds = pd.read_csv(valid_path)  #delimiter='\t')
...
class Model_Classifier(nn.Module):
    ...
    def forward(self, input_ids, attention_mask):
        ...
        last_hidden_state_cls = F.normalize(last_hidden_state_cls, p=2, dim=1)
